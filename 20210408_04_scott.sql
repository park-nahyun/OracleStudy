...
SELECT '751212-1234567' "주민번호", FN_GENDER('751212-1234567') "성별확인"
FROM DUAL;


SELECT '920909-2094612' "주민번호", FN_GENDER('920909-2094612') "성별확인"
FROM DUAL;
...
--==>> Table TBL_STUDENTS이(가) 생성되었습니다. -- 참고용.. 이렇게 만들지 말 것.. 
...
VALUES('supermen', '박정준', '010-1111-1111', '제주도 서귀포시');
...
SELECT *
FROM TBL_STUDENTS;
--==>> supermen	박정준	010-1111-1111	제주도 서귀포시
...
EXEC PRC_SUNGJUK_INSERT2(2, '박나현', 100, 95, 100);
EXEC PRC_SUNGJUK_INSERT3(3, '오세훈', 80, 95, 60);

SELECT HAKBUN "학번", NAME "이름", KOR "국어점수", ENG "영어점수", MAT "수학점수", TOT "총점", AVG "평균", GRADE "등급"
FROM TBL_SUNGJUK;
--==>>
/*
1	조은선	90	80	70	240	80	A
2	박나현	100	95	100	295	98.3	A
3	오세훈	80	95	60	235	78.3	C
*/


--○ 생성한 프로시저(PRC_SUNGJUK_INSERT)가 제대로 작동하는지의 여부 확인
--   → 프로시저 호출
EXEC PRC_SUNGJUK_UPDATE(1, 50, 10, 20);
--==>> PL/SQL 프로시저가 성공적으로 완료되었습니다.
